...
index_args = gallery_args.copy()
index_args.update({'template_name':'photologue/index.html',
                   'extra_context':{'sample_size':SAMPLE_SIZE,
                                    'photo_list': Photo.objects.filter(is_public=True)[:10],
                                    'num_latest':10,
                                    }})
urlpatterns = patterns('django.views.generic.date_based',
    url(r'^/?$', 'archive_index', index_args, name='pl-archive-index'),
